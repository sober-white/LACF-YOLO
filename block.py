...
class Contextfusion(nn.Module):
    ...
    def forward(self, x):
        ...
        local_w = self.local_att(recal_input)  ## 局部注意力 即spatial attention
        global_w = self.global_att(recal_input) ## 全局注意力 即channel attention
        x = self.sigmoid(local_w * global_w) ## 计算特征的权重 
